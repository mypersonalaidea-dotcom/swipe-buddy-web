 ...
 * ============================================================
 * Routes all calls (autocomplete, geocoding, reverse geocoding)
 * to the same provider configured via MAP_PROVIDER in config.ts.
 *
 * Usage:
 *   const maps = useMaps();               // uses global MAP_PROVIDER
 *   const maps = useMaps('mapbox');        // force Mapbox for this instance
 *
